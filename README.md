...
**Full Stack Developer** — Laravel · React Native · Vue.js · Next.js · TypeScript

I build web and mobile systems from backend to frontend, focusing on clean code, well-structured APIs, and functional UX.  
Professional experience with Laravel, Docker, and CI/CD at **Tuxon Soluções Web**.  
Pursuing a degree in **Systems Analysis and Development** at PUC Paraná.
